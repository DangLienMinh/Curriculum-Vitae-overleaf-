...
\myname{Dang}{L\bibnamedelima Minh}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Lien-Minh Dang}
  

 
 \makefield{\faPhone}{\texttt{+82 10 4999 9742}}
 
  \makefield{\faEnvelopeO}{\texttt{danglienminh93@gmail.com}}
  
   \makefield{\faBirthdayCake}{\texttt{26 June 1993}}


  \makefield{\faGithub}{\url{https://github.com/DangLienMinh}}

  \makefield{\faLinkedinSquare}
  {\url{https://www.linkedin.com/in/lienminh-dang/}}
}
